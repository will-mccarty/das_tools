...
def obs(data=None,return_deps=False,obs_var=None):
    if obs_var is not None:
        var = iod.var_to_var('ObsValue/OBSVAR',obs_var=obs_var)#.replace('OBSCAR',obs_var)
    else:
        print('warning, obs_var not set!')
    val = data[var]
    return(val)
   
def bkg(data=None,return_deps=False,obs_var=None):
    if obs_var is not None:
        var = iod.var_to_var('hofx/OBSVAR',obs_var=obs_var)#.replace('OBSCAR',obs_var)
    else:
        print('warning, obs_var not set!')
    val = data[var]
    return(val)
...
def gsibkgbc(data=None,return_deps=False,obs_var=None):
    if obs_var is not None:
        var = iod.var_to_var('GsiHofXBc/OBSVAR',obs_var=obs_var)#.replace('OBSCAR',obs_var)
    else:
        print('warning, obs_var not set!')
    val = data[var]
    return(val)

def gsibkgnbc(data=None,return_deps=False,obs_var=None):
    if obs_var is not None:
        var = iod.var_to_var('GsiHofX/OBSVAR',obs_var=obs_var)#.replace('OBSCAR',obs_var)
    else:
        print('warning, obs_var not set!')
    val = data[var]
    return(val)
